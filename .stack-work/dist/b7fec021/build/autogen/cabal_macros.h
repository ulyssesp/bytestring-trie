...
/* package bytestring-trie-0.3.0.3 */
#define VERSION_bytestring_trie "0.3.0.3"
...
/* package data-or-1.0.0.5 */
#define VERSION_data_or "1.0.0.5"
#define MIN_VERSION_data_or(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "bytestring-trie-0.3.0.3-HLFcIfm9b5G6WckdLkDVsX"

#define CURRENT_PACKAGE_KEY "bytestring-trie-0.3.0.3-HLFcIfm9b5G6WckdLkDVsX"
